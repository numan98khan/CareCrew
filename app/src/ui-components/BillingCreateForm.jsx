...
export default function BillingCreateForm(props) {
  ...
  const resetStateValues = () => {
    setAllowOvertime(initialValues.allowOvertime);
    setMaxBillingMonthly(initialValues.maxBillingMonthly);
    setRemainingBillingMonthly(initialValues.remainingBillingMonthly);
    setHourlyRate(initialValues.hourlyRate);
    setHourlyRateCNA(initialValues.hourlyRateCNA);
    setHourlyRateLPN(initialValues.hourlyRateLPN);
    setHourlyRateRN(initialValues.hourlyRateRN);
    setWeekendHourlyRate(initialValues.weekendHourlyRate);
    setHolidayHourlyRate(initialValues.holidayHourlyRate);
    setMaxMonthlyIncentive(initialValues.maxMonthlyIncentive);
    setRemainingMonthlyIncentive(initialValues.remainingMonthlyIncentive);
    setMaxHourlyIncentive(initialValues.maxHourlyIncentive);
    setMaxFixedIncentive(initialValues.maxFixedIncentive);
    setBillingEmail(initialValues.billingEmail);
    setBillingMonth(initialValues.billingMonth);
    setInvoiceDelivery(initialValues.invoiceDelivery);
    setInvoiceFrequency(initialValues.invoiceFrequency);
    setTopUpPercentage(initialValues.topUpPercentage);
    setErrors({});
  };
  const validations = {
    allowOvertime: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "BillingCreateForm")}
      {...rest}
    >
      <SwitchField
