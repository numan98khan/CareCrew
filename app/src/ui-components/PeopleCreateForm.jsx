...
export default function PeopleCreateForm(props) {
  ...
  const resetStateValues = () => {
    setSurrogateID(initialValues.surrogateID);
    ...
    setIsEmailNotifications(initialValues.isEmailNotifications);
    setIsTextNotification(initialValues.isTextNotification);
    setEffectiveStartDate(initialValues.effectiveStartDate);
    setDriverLicenseNumber(initialValues.driverLicenseNumber);
    setDriverLicenseState(initialValues.driverLicenseState);
    setSSN(initialValues.SSN);
    setUniformSize(initialValues.uniformSize);
    setIsCompleteDrugScreening(initialValues.isCompleteDrugScreening);
    ...
    setMilesToWork(initialValues.milesToWork);
    setLicenseCode(initialValues.licenseCode);
    setProfilePicture(initialValues.profilePicture);
    setRole(initialValues.role);
    setStatus(initialValues.status);
    setPersonalNote(initialValues.personalNote);
    setPayrollCycle(initialValues.payrollCycle);
    setEmail(initialValues.email);
    setPoints(initialValues.points);
    setRating(initialValues.rating);
    setPosition(initialValues.position);
    setIsTerminated(initialValues.isTerminated);
    setLastActivity(initialValues.lastActivity);
    setLastActivityNotifications(initialValues.lastActivityNotifications);
    ...
    setImmunization(initialValues.immunization);
    setErrors({});
  };
  const validations = {
    surrogateID: [],
