...
export default function FacilityUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = facilityRecord
      ? { ...initialValues, ...facilityRecord }
      : initialValues;
    setImgSrc(cleanValues.imgSrc);
    setFacilityName(cleanValues.facilityName);
    setAboutFacility(cleanValues.aboutFacility);
    ...
    setIsHidden(cleanValues.isHidden);
  ...
  const [facilityRecord, setFacilityRecord] = React.useState(facilityModelProp);
  React.useEffect(() => {
    ...
    queryData();
  }, [idProp, facilityModelProp]);
  React.useEffect(resetStateValues, [facilityRecord]);
  const validations = {
    imgSrc: [],
    facilityName: [],
    aboutFacility: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "FacilityUpdateForm")}
      {...rest}
    >
      <TextField
        label="Img src"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || facilityModelProp)}
